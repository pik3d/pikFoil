...
It is enough __jre package__ to run pikFoil. JRE can be freely download(~60 MB): <a href='https://www.azul.com/downloads/?os=windows&architecture=x86-64-bit&package=jre#zulu'>Azul Downloads</a><br>
